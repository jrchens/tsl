...
<div class="easyui-panel" title="Edit SysMenu" style="width:100%;max-width:400px;padding:30px 60px;">

    <form:form id="sys_menu_update_form" method="post" servletRelativeAction="/sys_menu/update.json" commandName="sysMenu">
        <form:hidden path="id"/>
        ...
        <div style="text-align:center;padding:5px 0">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="sys_menu_update()" style="width:80px" data-options="iconCls:'icon-save'">Update</a>
    ...
    <script type="text/javascript" src="/resources/js/sys_menu/edit.js"></script>
</div>
